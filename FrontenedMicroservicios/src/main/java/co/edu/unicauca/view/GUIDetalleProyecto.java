...
public class GUIDetalleProyecto extends javax.swing.JDialog {
    ...
    private void btnPostularseActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        estudiante = serviceStudent.obtenerEstudiante(username.trim());
        Long codigoEstudiante = Long.parseLong(estudiante.getCodigo());

        System.out.println("Codigo estudiante " + codigoEstudiante);
        if (proyecto.getId() != 0) {
           // Timestamp fechaActual = new Timestamp(System.currentTimeMillis());
            Postulation postulation = new Postulation(codigoEstudiante, proyecto.getId());
            postulation.setIdPostulation(null);
    ...
    private void inicializarDatos(Project proyecto) {
        ...
        txtEmpresa.setText(proyecto.getCompany().getNombre());
